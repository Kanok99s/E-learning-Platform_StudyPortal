  ...
  return (
    <div className="course">
      <div className="course__container">
        ...
        <div className="course__content text-white bg-transparent">
          <Tabs defaultValue="Notes" className="course__tabs">
            <TabsList className="course__tabs-list bg-transparent">
              <TabsTrigger className="course__tab text-white bg-transparent" value="Notes">
                Notes
              </TabsTrigger>
              <TabsTrigger className="course__tab text-white bg-transparent" value="Resources">
                Resources
              </TabsTrigger>
              <TabsTrigger className="course__tab text-white bg-transparent" value="Quiz">
                Quiz
              </TabsTrigger>
            </TabsList>

            <TabsContent className="course__tab-content text-white bg-transparent" value="Notes">
              <Card className="course__tab-card bg-transparent text-white">
            ...
            <TabsContent className="course__tab-content text-white bg-transparent" value="Resources">
              <Card className="course__tab-card bg-transparent text-white">
                <CardHeader className="course__tab-header">
            ...
            <TabsContent className="course__tab-content text-white bg-transparent" value="Quiz">
              <Card className="course__tab-card bg-transparent text-white">
                <CardHeader className="course__tab-header">
          ...
          <Card className="course__instructor-card bg-transparent text-white">
            <CardContent className="course__instructor-info">
              ...
              <div className="course__instructor-bio">
                <p>
                  A seasoned Senior UX Designer with over 15 years of experience in
                  creating intuitive and engaging digital experiences. Expertise in
                  leading UX design projects.
                </p>
              </div>
            </CardContent>
          </Card>
